    ...
    <footer className="w-full bg-white border-t border-slate-200 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Columna 1: El Sistema (DermaCore) */}
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
              Sistema integral de gestión dermatológica. Optimizando la atención
              clínica y la administración de pacientes con tecnología de punta.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 shadow-sm">
              <div className="flex items-center gap-3">
                {/* IMPORTANTE: el archivo existe como /public/Logo.png */}
                <Image
